...
function init() {
	...
	$("body").append("<div id='help'>Use left click to move<br>or use buttons on right</div>")
...
*/	
	...
	.append($('<img src="./img/moveBackward.png">')
	...
	.append($('<img src="./img/moveRight.png">')
