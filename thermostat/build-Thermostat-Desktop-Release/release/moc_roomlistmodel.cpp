...
#include "../../Thermostat/roomlistmodel.h"
...
const QMetaObject RoomListModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_RoomListModel.data,
      qt_meta_data_RoomListModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RoomListModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RoomListModel.stringdata0))
        return static_cast<void*>(const_cast< RoomListModel*>(this));
